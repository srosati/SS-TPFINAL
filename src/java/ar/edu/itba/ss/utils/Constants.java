...
public class Constants {
    ...
    public static final double RADIUS_AMPLITUDE = 0.12;

    public static final double WALL_RADIUS = 0.8;
    ...
    public static double PROP_FACTOR = 0.5;//1;
    public static double ANGULAR_W = 0.3;
}
